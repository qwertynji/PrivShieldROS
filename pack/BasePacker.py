...
import sys
import os
from pack.deploys import All_DeployToSend,Odomtery_DeployToSend,Image_DeployToSend,Imu_DeployToSend,CompressedImage_DeployToSend,data_to_upload
...
class BasePacker(object):
    ...
    def command_send(command,**kwargs):
       ...
       # 开启节点监听
           ...
           try:
               os.popen('/opt/ros/noetic/catkin_ws/src/listen_node/scripts/Utlimate/pack/monitor.sh')
           except Exception:
       ...
       # 发送消息
           ...
           try:
               ...
               data_to_upload(kwargs.get('redis'), kwargs.get('username'), key)
       ...
       # 查询链上信息
           ...
           tcp_cli.connect(('8.134.222.175',5500))
